            ...
            <Physics broadphase="SAP" allowSleep>
                {/* <Debug> */}
                    ...
                    {[...Array(5)].map((_,i) => {
                        ...
                        return <Lamppost key={'lamppostsLeftLane_' + depthPosition} position={[55,0,depthPosition]} />
                    })}
                    {[...Array(5)].map((_,i) => {
                        const initialDepthPosition = -10; 
                        const extraDistance = 25;
                        const depthPosition = initialDepthPosition + (i * extraDistance);
                        return <Lamppost key={'lamppostsRightLane_' + depthPosition} position={[-55,0,depthPosition]} />
                    })}
